...
class AndroidVideoPlayerApi {
  ...
  Future<TexturePlayerIds> createForGPUTextureView(CreationOptions options) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.createForGPUTextureView$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
    BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
