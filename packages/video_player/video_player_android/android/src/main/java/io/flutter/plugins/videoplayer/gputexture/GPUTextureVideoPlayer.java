 ...
 * the texture.
 */
public final class GPUTextureVideoPlayer extends VideoPlayer implements SurfaceProducer.Callback {
   ...
   */
  @NonNull
  public static GPUTextureVideoPlayer create(
          @NonNull Context context,
          @NonNull VideoPlayerCallbacks events,
          @NonNull SurfaceProducer surfaceProducer,
          @NonNull VideoAsset asset,
          @NonNull VideoPlayerOptions options) {
    return new GPUTextureVideoPlayer(
            events,
            surfaceProducer,
            asset.getMediaItem(),
            options,
  ...
  void setupSurface(Surface surface) {
    if (surface != null) {
      surfaceRenderer.initialize(surface);
      exoPlayer.setVideoSurface(surfaceRenderer.getInputSurface());
    }
  }
  ...
  protected ExoPlayerEventListener createExoPlayerEventListener(
    ...
    if (surfaceProducer == null) {
      throw new IllegalArgumentException(
              "surfaceProducer cannot be null to create an ExoPlayerEventListener for GPUTextureVideoPlayer.");
    }
    if (surfaceRenderer == null) {
      throw new IllegalStateException(
              "surfaceRenderer cannot be null to create an ExoPlayerEventListener for GPUTextureVideoPlayer.");
    }
    return new GPUTextureExoPlayerEventListener(
            exoPlayer,
            videoPlayerEvents,
            surfaceProducer,
            surfaceRenderer
  ...
  public void onSurfaceAvailable() {
    if (needsSurface) {
      ...
      setupSurface(surfaceProducer.getSurface());
      needsSurface = false;
    }
  }
  ...
  public void dispose() {
    ...
    // SurfaceRenderer must always be non-null.
